...
export default async function ContentPage() {
  ...
  try {
    ...
    blogPostsCount = results[0].count || 0
    caseStudiesCount = results[1].count || 0
    resourcesCount = results[2].count || 0
    projectsCount = results[3].count || 0
  } catch (error: any) {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className={cn(TYPOGRAPHY.h2)}>Content Management</h1>
